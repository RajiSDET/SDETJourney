...
public class SingleLinkedListImplementations_Govind {
	...
	//=============================AddALL==============================================================
	public void addALL(SingleLinkedListImplementations_Govind otherList) {
...
//=================================Add ALl at specfic index==============================================
	public void addAll(int index, SingleLinkedListImplementations_Govind otherList) {
	...
	public static void main(String[] args) {
		SingleLinkedListImplementations_Govind obj1 = new SingleLinkedListImplementations_Govind();
		...
		//5. Add All method
		SingleLinkedListImplementations_Govind obj2=new SingleLinkedListImplementations_Govind();
	    ...
	    SingleLinkedListImplementations_Govind obj3=new SingleLinkedListImplementations_Govind();
