...
public class Sep10_CW1_Dietary {
	
	@Test
	public void test1()
	{
		Assert.assertEquals(0, PointsCalc(new int[] {1,2,3,4,5},1,3,3));
	}
	
	@Test
	public void test2()
	{
		Assert.assertEquals(0, PointsCalc(new int[] {3,2},2,0,1));
	}
	
	public int PointsCalc(int[] calories,int k , int lower, int upper)
	{
		int points=0;
		int T=0;
...
INPUTS :  int[] calories , int k , int lower and int upper;
OUTPUT :  int points 
...
Output: 1
Explanation: Since k = 2, we consider sub-arrays of length 2.
