...
[7,7] --> "7"*/
	...
	public static void main(String[] args) {
		...
		System.out.println("Initial Size ="+CookieList.size());
		
		CookieList.removeAll(GreedList); 
		
		System.out.println("Final Size ="+CookieList.size());
		contentChildren=s.length-CookieList.size();
